...
class SafeOneViewController: UIViewController {
    ...
    private lazy var WelcomeImgView: UIImageView = {
        ...
        imageview.image = UIImage(named:"safeAction1")
    ...
    private let questionOneLabel: UILabel = {
        ...
        questionOneLabel.text = "Wash your hands to stay healthy"
