...
class SurveyViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.title="Survey"
        self.view.backgroundColor = .appNameColor
        ...
        let que1 = Question(imgName: "survey-images1", question: "Are you having any symptoms above?", positiveAns: false, isAnswered: false)
        let que2 = Question(imgName: "survey-images2", question: "Have you been travelling in between last 14 days?", positiveAns: false, isAnswered: false)
        let que3 = Question(imgName: "survey-images3", question: "Have you been exposed with crowded places?", positiveAns: false, isAnswered: false)
        let que4 = Question(imgName: "survey-images4", question: "Have you been interact with any sick person recently?", positiveAns: false, isAnswered: false)
...
extension SurveyViewController: SurveyCVCellDelegate {
    func didChooseAnswer(btnIndex: Int) {
        ...
        if btnIndex == 0 {
            questionsArray[index.item].positiveAns = true
            score += 1
        } else {
            //score += 1
        }
