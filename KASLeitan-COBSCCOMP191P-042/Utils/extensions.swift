...
extension UIColor {
    ...
    static let appNameColor = rgb(red: 235, green: 47, blue: 6)
    static let liteThemeColor = rgb(red: 255, green: 204, blue: 204)
    static let riskLevelGreen = rgb(red: 39, green: 174, blue: 96)
    static let riskLevelBlue = rgb(red: 52, green: 152, blue: 219)
    static let riskLevelLightYellow = rgb(red: 241, green: 196, blue: 15)
    static let riskLevelDarkYellow = rgb(red: 230, green: 126, blue: 34)
}
